...
import { MenuItem, TextField, Box, makeStyles, TextareaAutosize, Button, FormControl, InputBase} from '@material-ui/core';
...
const Createview =()=>{
    ...
    return (
        ...
        <img src="/assets/ProjectConnectors.png" alt="" className={classes.image} />
